...
<tileset name="tes" tilewidth="128" tileheight="128" spacing="2">
 ...
 <tile id="1">
  <properties>
   <property name="name" value="woodaxe"/>
   <property name="power" value="10"/>
  </properties>
 </tile>
 <tile id="2">
  <properties>
   <property name="hardness" value="0"/>
   <property name="name" value="water"/>
   <property name="swimmable" value="true"/>
  </properties>
 </tile>
 <tile id="3">
  <properties>
 ...
 <tile id="4">
  <properties>
   <property name="name" value="stoneAxe"/>
   <property name="power" value="100"/>
  </properties>
 </tile>
 <tile id="5">
  <properties>
   <property name="name" value="steelAxe"/>
   <property name="power" value="1000"/>
  </properties>
 </tile>
 <tile id="6">
  <properties>
   <property name="hardness" value="100"/>
   <property name="name" value="rock"/>
  </properties>
 </tile>
 <tile id="7">
  <properties>
   <property name="hardness" value="1"/>
   <property name="name" value="mud"/>
  </properties>
 </tile>
 <tile id="8">
  <properties>
   <property name="hardness" value="10"/>
   <property name="name" value="mildRock"/>
  </properties>
 </tile>
 <tile id="9">
  <properties>
